...
function Svg(props) {
  const { className = "", size = "base", ...restProps } = props;
  const classNameSize = sizes[size];
  return (
    <svg
      className={`fill-current ${className} ${classNameSize}`}
      width="1em"
      height="1em"
      viewBox="0 0 24 24"
      {...restProps}
...
export function IconTwitterLogo(props) {
  return (
    <Svg {...props}>
      <g>
...
export function IconPoll(props) {
  return (
    <Svg {...props}>
      <g>
  ...
  return (
    <Svg {...props}>
      ...
      <circle
        ...
        stroke="#1DA1F2"
        strokeLinecap="round"
        style={{ strokeDashoffset: "55.3369", strokeDasharray: "56.5487" }}
      ></circle>
    </Svg>
  );
}
